...
export class EditContactFormComponent  implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'edit-contact-form';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
  ...
  postForm(): void {
    this._dataService.postData("post-edit-contact-form", this.formData).subscribe((data: any)=> { 
      //this.data=data;
      //this.formData=data['formData'];
      this.closeIt();
      console.log(this.data)
