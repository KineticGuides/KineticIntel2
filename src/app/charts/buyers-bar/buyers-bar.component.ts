...
@Component({
  selector: 'app-buyers-bar',
  standalone: true,
  imports: [CommonModule, FormsModule,  NgChartsModule],
  templateUrl: './buyers-bar.component.html',
  styleUrl: './buyers-bar.component.css'
})
export class BuyersBarComponent  implements OnInit {
...
public barChartData: ChartConfiguration<'bar'>['data'] = {
  ...
  {      
      ...
      this._dataService.getData("get-buysell-graph", this.id, this.id2, this.symbol).subscribe((data: any)=> { 
        this.data=data;
        this.labels=data.labels;
        this.buyers=data.buyers;
        this.sellers=data.sellers;  
        this.barChartData.labels = [ ...this.labels ];
        this.barChartData.datasets[1].data = [ ...this.sellers ];
        this.barChartData.datasets[0].data = [ ...this.buyers ];
        this.updateChart();
    });
  }
