...
@Component({
  selector: 'app-shareholder-line',
  standalone: true,
  imports: [CommonModule, FormsModule,  NgChartsModule],
  templateUrl: './shareholder-line.component.html',
  styleUrl: './shareholder-line.component.css'
})
export class ShareholderLineComponent   implements OnInit {
...
formatYYYYMMDDtoMMDD(dateStr: string): string {
  ...
  ngOnInit(): void
  {      
    this._dataService.getData("get-shareholder-graph", this.id, this.id2, this.symbol).subscribe((data: any)=> { 
