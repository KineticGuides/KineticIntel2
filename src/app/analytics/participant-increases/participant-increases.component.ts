...
@Component({
  selector: 'app-participant-increases',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, HeySkipperComponent, NgChartsModule, ShareholderLineComponent],
  templateUrl: './participant-increases.component.html',
  styleUrl: './participant-increases.component.css'
})
export class ParticipantIncreasesComponent  implements OnInit {
