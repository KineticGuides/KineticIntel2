...
@Component({
  selector: 'app-lost-positons',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, HeySkipperComponent, NgChartsModule, ShareholderLineComponent],
  templateUrl: './lost-positons.component.html',
  styleUrl: './lost-positons.component.css'
})
export class LostPositonsComponent  implements OnInit {
