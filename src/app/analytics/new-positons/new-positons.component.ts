...
@Component({
  selector: 'app-new-positons',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, HeySkipperComponent, NgChartsModule, ShareholderLineComponent],
  templateUrl: './new-positons.component.html',
  styleUrl: './new-positons.component.css'
})
export class NewPositonsComponent  implements OnInit {
