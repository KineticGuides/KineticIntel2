...
@Component({
  selector: 'app-lost-participants',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, HeySkipperComponent, NgChartsModule, ShareholderLineComponent],
  templateUrl: './lost-participants.component.html',
  styleUrl: './lost-participants.component.css'
})
export class LostParticipantsComponent  implements OnInit {
