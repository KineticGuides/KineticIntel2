...
@Component({
  selector: 'app-participant-decreases',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, HeySkipperComponent, NgChartsModule, ShareholderLineComponent],
  templateUrl: './participant-decreases.component.html',
  styleUrl: './participant-decreases.component.css'
})
export class ParticipantDecreasesComponent  implements OnInit {
